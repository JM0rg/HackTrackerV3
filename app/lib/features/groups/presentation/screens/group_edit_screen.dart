...
/// Create (null [group]) or edit a group. New groups are scoped to the
/// currently selected team; when editing, the team is fixed.
...
class _GroupEditScreenState extends ConsumerState<GroupEditScreen> {
  ...
  Future<void> _save() async {
    final teamId = widget.group?.teamId ?? ref.read(currentTeamIdProvider);
